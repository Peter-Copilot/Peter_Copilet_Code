...
turtle.hideturtle()
while True:
    color = turtle.textinput("请输入", "你要什么颜色的冰墩墩？(black/yellow/red/blue/white/green)(默认为黑色)")
    color = str(color)

    if color == 'black' or color == 'yellow' or color == 'red' or \
    color == 'blue' or color == 'white' or color == 'green':
        break
    elif color == '':
        color = 'black'
        break
